/*--------------------------------------------------------------
Programmer: Ethan Powell
Summary: This program includes two efficient GCD algorithms, each tested in the main function: findEuclidGCD is
Euclid's algorithm, and findBinaryGCD is the binary GCD algorithm, or Stein's algorithm.
...
short findBinaryGCDRecursive(long num_1, long num_2, short factors_of_2)
{
    ...
    {
        if (num_2 % 2 == 0) // if both even
        {
            //factors_of_2++;
            return 2* findBinaryGCDRecursive(num_1 / 2, num_2 / 2, factors_of_2);
        }
